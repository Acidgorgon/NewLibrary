...
-- Load the library (replace with your actual loadstring / require)
local Library = loadstring(game:HttpGet("https://gist.githubusercontent.com/Acidgorgon/2c0654b99a77b27e801ca6eb952a1e6c/raw/e3100065f2e4e711087fccd3d8a2f4f9a3a5b5ce/UILib"))()
...
Library:InitLoad({
    Title       = "NEXUS HUB",
    SubTitle    = "All-Feature Demo v1.0",
    Icon        = 3926307971,          -- rbxassetid
    Duration    = 5,
    AccentColor = Color3.fromRGB(0, 200, 145),
    Statuses    = {
...
-- Override specific theme colours
Window:SetTheme({
    MainColor    = Color3.fromRGB(28, 28, 28),
    FrameColor   = Color3.fromRGB(22, 22, 22),
    LineColor    = Color3.fromRGB(0, 200, 145),
})
...
-- ══════════════════════════════════════════════════════════════
local MainTab = Window:Tab("Main", 4483362458)
...
--  TAB 2 — INPUT & TEXT
-- ══════════════════════════════════════════════════════════════
local InputTab = Window:Tab("Input", 3926305904)
...
--  TAB 4 — DATA WIDGETS
-- ══════════════════════════════════════════════════════════════
local DataTab = Window:Tab("Data", 4483362458)
...
console:Print("[SYSTEM] Nexus Hub initialised.", Color3.fromRGB(0, 200, 145))


-- ══════════════════════════════════════════════════════════════
--  TAB 5 — GRID & DIALOG
-- ══════════════════════════════════════════════════════════════
local GridTab = Window:Tab("Grid", 3926305904)
